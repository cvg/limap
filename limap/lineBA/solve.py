from _limap import _base, _ceresbase, _lineBA
import numpy as np

def solve(cfg, reconstruction, vpresults=None, heatmaps=None, patches_list=None, dtype="float16", max_num_iterations=100):
    '''
    patches_list: list of PatchInfo_f objects
    '''
    ba_config = _lineBA.LineBAConfig(cfg)
    ...
    lineba_engine = getattr(_lineBA, lineba_engine_name)(ba_config)
