...
void bind_hybrid_bundle_adjustment(py::module &m) {
    ...
    py::class_<HybridBAConfig>(m, "HybridBAConfig")
        ...
        .def_readwrite("point_geometric_loss_function", &HybridBAConfig::point_geometric_loss_function)
        .def_readwrite("line_geometric_loss_function", &HybridBAConfig::line_geometric_loss_function)
    ...
    py::class_<HybridBAEngine>(m, "HybridBAEngine")
        ...
        .def("InitPointTracks", static_cast<void (HybridBAEngine::*)(const std::vector<PointTrack>&)>(&HybridBAEngine::InitPointTracks))
        .def("InitPointTracks", static_cast<void (HybridBAEngine::*)(const std::map<int, PointTrack>&)>(&HybridBAEngine::InitPointTracks))
        .def("InitLineTracks", static_cast<void (HybridBAEngine::*)(const std::vector<LineTrack>&)>(&HybridBAEngine::InitLineTracks))
        .def("InitLineTracks", static_cast<void (HybridBAEngine::*)(const std::map<int, LineTrack>&)>(&HybridBAEngine::InitLineTracks))
        ...
        .def("GetOutputLines", &HybridBAEngine::GetOutputLines, py::arg("num_outliers") = 2)
        .def("GetOutputLineTracks", &HybridBAEngine::GetOutputLineTracks, py::arg("num_outliers") = 2);
}
