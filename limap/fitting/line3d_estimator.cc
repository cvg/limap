...
std::pair<Line3d, ransac_lib::RansacStatistics> Fit3DPoints(const Eigen::Matrix3Xd points, const ransac_lib::LORansacOptions& options_) {
    ...
    ransac_lib::LocallyOptimizedMSAC<InfiniteLine3d, std::vector<InfiniteLine3d>, Line3dEstimator> lomsac;
