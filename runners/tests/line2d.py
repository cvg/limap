...
view1 = limap.base.CameraView("runners/tests/data/line2d/frame.0000.color.jpg") # initiate an limap.base.CameraView instance for detection.
view2 = limap.base.CameraView(limap.base.Camera("SIMPLE_PINHOLE", hw=(800, 800)), "runners/tests/data/line2d/frame.0000.color.jpg") # You can specify the height and width to resize into in the limap.base.Camera instance at initialization.
...
# match lines
matcher = limap.line2d.get_matcher({"method": "sold2", "skip_exists": False, "n_jobs": 1, "topk": 0}, extractor) # set topk to 0 for mutual nearest neighbor matching
