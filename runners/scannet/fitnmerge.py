...
def run_scene_scannet(cfg, dataset, scene_id):
    imagecols, neighbors, depths = read_scene_scannet(cfg, dataset, scene_id, load_depth=True)
    linetracks = limap.runners.line_fitnmerge(cfg, imagecols, depths, neighbors=neighbors)
    return linetracks
