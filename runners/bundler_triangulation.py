...
def read_scene_bundler(cfg, bundler_path, list_path, model_path, n_neighbors=20):
    ...
    if cfg["info_path"] is None:
        imagecols, neighbors, ranges = _psfm.read_infos_bundler(cfg["sfm"], bundler_path, list_path, model_path, n_neighbors=n_neighbors)
