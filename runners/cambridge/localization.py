...
from utils import read_scene_visualsfm, get_scene_info, get_result_filenames, eval, undistort_and_resize, run_hloc_cambridge
...
def main():
    ...
    train_ids, query_ids, id_to_origin_name = get_scene_info(cfg['vsfm_path'], imagecols, args.query_images)
