...
class BaseMatcher:
    ...
    @typechecked
    def get_matches_folder(self, output_folder: Path) -> Path:
        """
        ...
        Returns:
            path_to_matches (pathlib.Path): The path to the saved matches
        """
        return (
            output_folder
    ...
    @typechecked
    def get_match_filename(self, matches_folder: Path, idx: int) -> Path:
        """
        ...
        Args:
            ...
            idx (int): image id
        """
        fname = matches_folder / f"matches_{idx}.npy"
        return fname

    @typechecked
    def save_match(
        self, matches_folder: Path, idx: int, matches: dict[int, np.ndarray]
    ) -> None:
        """
    ...
    @typechecked
    def read_match(
        self, matches_folder: Path, idx: int
    ) -> dict[int, np.ndarray]:
        """
