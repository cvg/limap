...
class WunschLineMatcher:
    ...
    def compute_matches_topk_gpu(self, descinfo1, descinfo2, topk=10):
        desc1, valid_points1 = descinfo1
        desc2, valid_points2 = descinfo2
        len1, len2 = valid_points1.shape[0], valid_points2.shape[0]
    ...
    def compute_matches_topk(self, descinfo1, descinfo2, topk=10):
        desc1, valid_points1 = descinfo1
        desc2, valid_points2 = descinfo2
        len1, len2 = valid_points1.shape[0], valid_points2.shape[0]
        ...
        matches = self.filter_and_match_lines_topk(scores, topk=topk)
        return matches

    def compute_matches(self, descinfo1, descinfo2):
        desc1, valid_points1 = descinfo1
        desc2, valid_points2 = descinfo2
        len1, len2 = valid_points1.shape[0], valid_points2.shape[0]
    ...
    def forward(self, line_seg1, line_seg2, desc1, desc2):
        ...
        matches = self.compute_matches(descinfo1, descinfo2)
        return matches
    ...
    def filter_and_match_lines_topk_gpu(self, scores, topk=10):
    ...
    def get_pairwise_distance(self, line_seg1, line_seg2, desc1, desc2):
        ...
        assert num_lines == len(line_seg2), (
