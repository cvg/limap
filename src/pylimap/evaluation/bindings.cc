...
void bind_evaluator(py::module &m) {
  ...
  py::classh<PointCloudEvaluator>(m, "PointCloudEvaluator",
      ...
      .def(
          ...
          R"(
                    ...
                    Args:
                        line (Line3d): :class:`~limap.geometry.Line3d`: instance
      ...
      .def(
          ...
          R"(
                ...
                Args:
                    lines (list[:class:`limap.geometry.Line3d`]): Input 3D line segments
                    threshold (float): threshold
                    n_samples (int): number of samples (default = 1000)

                Returns:
                    list[:class:`limap.geometry.Line3d`]: Inlier parts of all the lines, useful for visualization
      ...
      .def(
          ...
          R"(
                ...
                Returns:
                    list[:class:`limap.geometry.Line3d`]: Outlier parts of all the lines, useful for visualization
  ...
  py::classh<MeshEvaluator>(m, "MeshEvaluator")
      .def(py::init<>(), R"(
            Default constructor
        )")
  ...
  py::classh<RefLineEvaluator>(m, "RefLineEvaluator")
      .def(py::init<>())
